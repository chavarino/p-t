       ...
       /* stage('Testing') {
        ...
        stage('deploy') {
            ...
            steps {
                ...
                build job: 'deployer', parameters: [string(name: 'APP_NAME', value:"$APP_NAME"), string(name:'APP_ENVIROMENT', value: "$APP_ENVIROMENT"), string(name:'USER_ANSIBLE', value: "$USER_ANSIBLE"), string(name:'JOB_NAME', value: "$JOB_NAME")]
